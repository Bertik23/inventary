    ...
    html! {
        <div class="max-w-lg mx-auto p-4 min-h-screen bg-gray-50">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-800">{"Quick Items"}</h1>
            ...
            <div class="mb-8 bg-white p-5 rounded-xl shadow-sm border border-gray-100">
                <h2 class="text-lg font-semibold mb-4 text-gray-700">{"Add New Quick Item"}</h2>
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">{"Name (e.g., Apple, Flour)"}</label>
                        <input
                            type="text"
            ...
            <h2 class="text-lg font-semibold mb-3 text-gray-700">{"Manage Quick List"}</h2>
            <p class="text-sm text-gray-500 mb-4">{"Global items can be overridden for this inventory."}</p>
            if *loading {
                            ...
                            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col gap-3">
                                <div class="flex justify-between items-center">
                                    <div>
                                        ...
                                        if is_global {
                                            <span class="text-[10px] uppercase tracking-wider font-bold text-gray-400">{"Global Default"}</span>
                                        } else {
                                            <span class="text-[10px] uppercase tracking-wider font-bold text-blue-500">{"Inventory Specific"}</span>
                                        }
                                    </div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    if is_global {
                                        ...
                                        >
                                            <option value="pcs" selected={current_unit == "pcs"}>{"pcs"}</option>
                                            <option value="kg" selected={current_unit == "kg"}>{"kg"}</option>
                                            <option value="g" selected={current_unit == "g"}>{"g"}</option>
                                            <option value="l" selected={current_unit == "l"}>{"l"}</option>
                                            <option value="ml" selected={current_unit == "ml"}>{"ml"}</option>
                                        </select>
                                    }
                                </div>
                            </div>
