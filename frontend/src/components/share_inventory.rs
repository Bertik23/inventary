    ...
    html! {
        <div class="max-w-lg mx-auto p-4 min-h-screen bg-gray-50">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-800">{"Share Inventory"}</h1>
            ...
            <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 mb-6">
                <h2 class="text-lg font-semibold mb-3 text-gray-700">{"Add User"}</h2>
            ...
            <h2 class="text-lg font-semibold mb-3 text-gray-700">{"Shared With"}</h2>
            if *loading {
                    ...
                    {for shared_users.iter().map(|user| {
                        ...
                        html! {
                            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex justify-between items-center">
                                ...
                                <button onclick={Callback::from(move |_| on_unshare.emit(user_id.clone()))} class="px-3 py-1 bg-red-100 text-red-700 rounded-md hover:bg-red-200">{"Remove"}</button>
                            </div>
                        }
                    })}
                </div>
